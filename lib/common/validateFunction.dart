...
String newFormattingDate(DateTime date) {
  return DateFormat('dd-MM-yyyy').format(date).toString();
}

String formattingWithMonth(DateTime date) {
  return DateFormat('dd-MMM-yyyy').format(date).toString();
}

String formattingWithMonthYear(DateTime date) {
...
screenShotToggle(int toggle) async {
  if (toggle == 1) {
